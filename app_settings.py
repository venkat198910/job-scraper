...
DEFAULT_SETTINGS = {
    ...
    "advanced": {
        ...
        "jobsToRescorePerRun": getattr(config, "JOBS_TO_RESCORE_PER_RUN", 0),
...
def normalize_settings(value: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "advanced": {
            ...
            "jobsToRescorePerRun": _bounded_int(incoming_advanced.get("jobsToRescorePerRun"), defaults["advanced"]["jobsToRescorePerRun"], 0, 1000),
            ...
            "appliedJobRetentionDays": _bounded_int(incoming_advanced.get("appliedJobRetentionDays"), defaults["advanced"]["appliedJobRetentionDays"], 1, 3650),
